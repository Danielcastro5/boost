...
<head>
  <meta charset="UTF-8">
  <title>Asesoria de finanzas</title>
...
<div class="contenido">
  <h2>Profecionales en finanzas</h2>
  <div class="grid-perfiles">
    <div class="perfil">
      <img src="img/ff1.jpg" alt="Dra. Laura Gómez">
      <h3>Dra. Mariana López</h3>
  <p>Contadora pública experta en auditoría fiscal y planeación tributaria.</p>
      <a href="perfil.php?id=1">Ver perfil</a>
    </div>
    <div class="perfil">
      <img src="img/fm1.jpg" alt="Lic. Andrés Ruiz">
     <h3>Lic. Esteban Ramírez</h3>
  <p>Asesor financiero especializado en inversiones y gestión patrimonial.</p>
      <a href="perfil.php?id=2">Ver perfil</a>
    </div>
    <div class="perfil">
      <img src="img/ff2.JPG" alt="Dra. Camila Torres">
      <h3>Dra. Natalia Herrera</h3>
  <p>Contadora con enfoque en contabilidad internacional y normas NIIF.</p>
      <a href="perfil.php?id=3">Ver perfil</a>
    </div>
    <div class="perfil">
      <img src="img/fm2.jpg" alt="Lic. Andrés Ruiz">
      <h3>Lic. Jorge Medina</h3>
  <p>Consultor en finanzas personales y planificación de ahorro a largo plazo.</p>
      <a href="perfil.php?id=4">Ver perfil</a>
    </div>
  </div>
</div>
